package com.epam.training.Asilbek_Makhmudov.beware_of_dogs;

import com.epam.training.Asilbek_Makhmudov.beware_of_dogs.house.House;
import com.epam.training.Asilbek_Makhmudov.beware_of_dogs.residents.cats.Cat;
import com.epam.training.Asilbek_Makhmudov.beware_of_dogs.residents.cats.Kitten;
import com.epam.training.Asilbek_Makhmudov.beware_of_dogs.residents.dogs.Dog;
import com.epam.training.Asilbek_Makhmudov.beware_of_dogs.residents.dogs.Puppy;
...
class HouseTest {
    ...
    void shouldCheckGenericTypeParameters() {
        ...
        assertEquals(1, houseTypes.length, "You must parametrize the House class");
        String houseType = houseTypes[0].getTypeName();
        try {
            Field field = House.class.getDeclaredField("residents");
            assertEquals(field.getGenericType().getTypeName(),
