...
public class QuadrilateralTest {
    ...
    static Stream<Arguments> testCentroidCases() throws IOException {
        Iterator<String> it = Files.readAllLines(Paths.get("src/test/java/com/epam/training/Asilbek_Makhmudov/figures_extra/resources/quadrilateral-centroid.txt")).iterator();
